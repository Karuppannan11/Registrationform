...
const handlesubVarity = (value) => {
  ...
  const [selectedcropsubvariety3, setSelectedcropsubvariety3] = useState(''); */}
      ...
      <div className="form-group">
            ...
            <div className="Irrigation">
              ...
              <div class="checkbox-group-container">
                ...
                <div className="checkbox-group" value={selectedLivestockbuffalow} onChange={(e) => setSelectedLivestockbuffalow(e.target.value)}>
                  <label>
                    <input type="checkbox" id="buffalow2" value="buffalow" name="buffalow" checked={showFields.buffalow} onChange={handleCheckboxChange} /> Buffalow
                  </label>
                </div>
        ...
        {showFields.buffalow && (
          <div className="drop">
            <span style={{ backgroundColor: 'forestgreen', fontWeight: 'bold', color: 'white', padding: '8px 16px', textAlign: 'center', display: 'inline-block', fontSize: '16px', margin: '4px 2px', borderRadius: '8px', }}>2.Livestock details of Buffalow</span>
            <div className="form-row">
              <div className="form-group">
                <label htmlFor="noOfLivestock">No of Livestock</label>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <div className="checkbox-group" value={selectedLiveStockInsuranceDetails} onChange={(e) => setSelectedLiveStockInsuranceDetails(e.target.value)}>
              ...
              <label>
                <input type="checkbox" id="buffalow" name="buffalow" checked={showFields.buffalow} onChange={handleCheckboxChange} /> Buffalow
              </label>
              <label>
